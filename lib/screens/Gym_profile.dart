...
class GymProfile extends StatelessWidget {
  const GymProfile({Key? key}) : super(key: key);

  static const screenRoute = '/gym-profile';

  @override
  Widget build(BuildContext context) {
    final gymId = ModalRoute.of(context)?.settings.arguments as String;
    final gym = GYMINFO.firstWhere((gym) => gym.id == gymId);
